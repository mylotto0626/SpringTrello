...
public class UserAdminController {
    ...
    public void changeUserRole(@AuthenticationPrincipal AuthUser authUser, @PathVariable("userId") long userId, @RequestBody UserRoleChangeRequest userRoleChangeRequest) {
