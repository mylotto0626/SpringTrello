...
public class QBoard extends EntityPathBase<Board> {
    ...
    private static final long serialVersionUID = 516113134L;
    ...
    public final ListPath<ListEntity, QListEntity> lists = this.<ListEntity, QListEntity>createList("lists", ListEntity.class, QListEntity.class, PathInits.DIRECT2);
